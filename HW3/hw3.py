...
Original file is located at
    https://colab.research.google.com/drive/1y2UJqWhf63K77lxxFK9hbpyOPOQZ_bLI
...
def identity_block(X, f, filters):
    ...
    # First component of main path
    X = Conv2D(filters=num_filters_1, kernel_size=(1,1), strides=(1,1), padding='valid', kernel_initializer=glorot_uniform(seed=0))(X)
    X = BatchNormalization()(X)
    X = Activation('relu')(X)

    # Second component of main path (≈3 lines)
    X = Conv2D(filters=num_filters_2, kernel_size=(f,f), strides=(1,1), padding='same', kernel_initializer=glorot_uniform(seed=0))(X)
    X = BatchNormalization()(X)
    X = Activation('relu')(X)

    # Third component of main path (≈2 lines)
    X = Conv2D(filters=num_filters_3, kernel_size=(1,1), strides=(1,1), padding='valid', kernel_initializer=glorot_uniform(seed=0))(X)
    X = BatchNormalization()(X)
...
def convolutional_block(X, f, filters,stride=2):
    ...
    # First component of main path 
    X = Conv2D(filters=num_filters_1, kernel_size=(1,1), strides=(stride,stride), padding='valid', kernel_initializer=glorot_uniform(seed=0))(X)
    X = BatchNormalization()(X)
    X = Activation('relu')(X)
    ...
    X_copy = Conv2D(filters=num_filters_3, kernel_size=(1,1), strides=(stride,stride), padding='valid', kernel_initializer=glorot_uniform(seed=0))(X_copy)
